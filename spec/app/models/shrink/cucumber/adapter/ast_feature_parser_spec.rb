describe Shrink::Cucumber::Adapter::AstFeatureParser do
  ...
  context "#tag_names" do
    ...
    describe "when source_tag_names are in the Cucumber::Ast::Feature" do
      ...
      before(:each) do
        ...
        @feature_parser = Shrink::Cucumber::Adapter::AstFeatureParser.new(cucumber_ast_feature)
      end
  ...
  def create_parser_for(cucumber_ast_feature_name)
    ...
    Shrink::Cucumber::Adapter::AstFeatureParser.new(cucumber_ast_feature)
  end
