describe Shrink::Cucumber::Adapter::AstFeatureAdapter do
  ...
  context "#adapt" do
    ...
    before(:each) do
      ...
      @feature_parser = mock("Shrink::Cucumber::Adapter::AstFeatureParser", :tag_names => [], :title => "", :lines_text => [])
      Shrink::Cucumber::Adapter::AstFeatureParser.stub!(:new).with(@cucumber_ast_feature).and_return(@feature_parser)

      @scenario_adapter = mock("Shrink::Cucumber::Adapter::AstScenarioAdapter", :null_object => true)
    ...
    describe "creates a Shrink::Feature when provided a Cucumber::Ast::Feature that" do
      ...
      it "should have tags whose names are retrieved from the Shrink::Cucumber::Ast::FeatureParser" do
        ...
        @feature.tags.collect(&:name).should eql(tag_names)
      end

      it "should have a title retrieved from the Shrink::Cucumber::Adapter::AstFeatureParser" do
      ...
      it "should have description lines retrieved from the Shrink::Cucumber::Adapter::AstFeatureParser" do
