describe Shrink::Cucumber::Adapter::AstStepAdapter do
  ...
  context "#adapt" do
    ...
    before(:each) do
      @table_adapter = mock("TableAdapter", :null_object => true)
      ...
      describe "and a multi-line argument" do
        ...
        describe "that is a Cucumber::Ast::Table" do
          ...
          it "should create a Shrink::Table via the configured table adapter" do
            @table_adapter.should_receive(:adapt).with(@cucumber_table)
