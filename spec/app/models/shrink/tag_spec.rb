module Shrink
  describe Tag do
    ...
    it "should be a Shrink::FeatureSummaryChangeObserver" do
      Tag.include?(Shrink::FeatureSummaryChangeObserver).should be_true
    end

    it "should be a Shrink::Cucumber::Formatter::TagFormatter" do
      Tag.include?(Shrink::Cucumber::Formatter::TagFormatter).should be_true
    end
