describe Platter::Cucumber::FeatureAdapter do
  ...
  context "#to_feature" do
    ...
    describe "when a file is provided" do
      ...
      it "should adapt the file to a feature via the Platter::Cucumber::FeatureFileReader" do
        feature = mock("Feature")
        Platter::Cucumber::FeatureFileReader.should_receive(:read).with(@file).and_return(feature)

        Platter::Cucumber::FeatureAdapter.to_feature(@file).should eql(feature)
      end
  ...
  context "#to_file" do
    ...
    describe "when a feature, file system and destination directory are provided" do
      ...
      before(:each) do
        ...
        Platter::Cucumber::FeatureFileManager.stub!(:name_for).and_return("file name")
      end
      ...
      it "should create a file on the file system whose name is provided by the Platter::Cucumber::FeatureFileManager" do
        Platter::Cucumber::FeatureFileManager.should_receive(:name_for).with(@feature).and_return("feature file name")
      ...
      def to_file
        Platter::Cucumber::FeatureAdapter.to_file(@feature, @file_system, @destination_directory)
      end
