describe Platter::FolderImporter do
  ...
  context "#import" do
    ...
    before(:each) do
      ...
      Platter::FolderImporter::ZipImporter.stub!(:new).and_return(@zip_importer)
    end

    it "should perform the import via a ZipImporter" do
      Platter::FolderImporter::ZipImporter.should_receive(:new).with(hash_including(
  ...
  describe Platter::FolderImporter::ZipImporter do

    before(:each) do
      @zip_importer = Platter::FolderImporter::ZipImporter.new(
